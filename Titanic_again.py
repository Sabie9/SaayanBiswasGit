...
train1=data.drop(['PassengerId','Survived','Name','Ticket','Embarked'],axis=1)
test1=data1.drop(['PassengerId','Name','Ticket','Embarked'],axis=1)
...
#train1=data.drop(['PassengerId','Survived','Name','Ticket','Cabin','Embarked'],axis=1)
#test1=data1.drop(['PassengerId','Name','Ticket','Cabin','Embarked'],axis=1)
#test2=data2.drop(['PassengerId'],axis=1)
